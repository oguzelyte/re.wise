...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["register-register-module"], {
  ...
  function srcAppRegisterRegisterPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _firebase_op_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../firebase-op.service */
    "./src/app/firebase-op.service.ts");

    var RegisterPage = /*#__PURE__*/function () {
      function RegisterPage(authService, router, toast, firebaseOp) {
      ...
      _createClass(RegisterPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.firebaseOp.getUniversities().subscribe(function (data) {
        ...
        key: "signUp",
        value: function signUp(email, password, name, username, studentNo, university) {
          var _this2 = this;

          this.authService.RegisterUser(email.value, password.value, name.value, username.value, studentNo.value, university.value).then(function (res) {
            // Do something here
            _this2.authService.SendVerificationMail();

            _this2.router.navigate(['../verify-email']);

            _this2.presentToast("You have been registered.");
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_authenticate_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticateService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ToastController"], _firebase_op_service__WEBPACK_IMPORTED_MODULE_5__["FirebaseOpService"]])], RegisterPage);
    /***/
  }
}]);
