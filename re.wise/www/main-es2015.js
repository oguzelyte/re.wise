...
const routes = [
    ...
    {
        path: 'verify-email',
        loadChildren: () => Promise.all(/*! import() | verify-email-verify-email-module */[__webpack_require__.e("common"), __webpack_require__.e("verify-email-verify-email-module")]).then(__webpack_require__.bind(null, /*! ./verify-email/verify-email.module */ "./src/app/verify-email/verify-email.module.ts")).then(m => m.VerifyEmailPageModule)
    },
    {
        path: 'insert',
        loadChildren: () => Promise.all(/*! import() | uploads-insert-insert-module */[__webpack_require__.e("common"), __webpack_require__.e("uploads-insert-insert-module")]).then(__webpack_require__.bind(null, /*! ./uploads/insert/insert.module */ "./src/app/uploads/insert/insert.module.ts")).then(m => m.InsertPageModule)
    }
];
...
/* harmony import */ var _angular_fire_storage__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @angular/fire/storage */ "./node_modules/@angular/fire/fesm2015/angular-fire-storage.js");
...
module.exports = __webpack_require__(/*! C:\Users\Oli\Desktop\re.wise\src\main.ts */"./src/main.ts");
